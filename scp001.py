...
def restricted():
    ...
    speak("ACCESS DENIED")
    speak("ACCESS TO SCP-001 is restricted TO O-five COUNCIL MEMBERS ONLY.")
    speak("unauthorized personal access will be terminated through a memetic kill agent.")
    speak("this file has been classified as top secret by order of the administrator.")
    time.sleep(1)
    print("")