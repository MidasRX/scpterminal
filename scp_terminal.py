...
def suppress_exceptions(exc_type, exc_value, exc_traceback):
    pass

sys.excepthook = suppress_exceptions
    ...
    if __name__ == "__main__":
        ...
        while(1):
            ...
            if usr.startswith("scp"):
                ...
                print("")
                print(Fore.LIGHTBLACK_EX +"Copyright © 2024 SCP Foundation".center(100))
                ...
                print("Copyright © 2024 SCP Foundation - SCP Foundation Terminal v2.1.5".center(100))
                ...
                print(Fore.LIGHTBLACK_EX +
                    "Copyright © 2024 SCP Foundation".center(100))
...
print("")
print(Fore.LIGHTBLACK_EX +
      "Copyright © 2024 SCP Foundation - SCP Foundation Terminal v2.1.5")
time.sleep(1)
os.system('cls')
...
# Copyright (c) 2024 SCP Foundation - SCP Foundation Terminal v2.1.5
